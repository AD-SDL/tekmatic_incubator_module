...
class Interface:
    ...
    def open_connection(self, port):
        ...
        #     return response
        print("opened connection")  # TESTING
    ...
    def close_connection(self):
        ...
        print("closed connection")  # TESTING
    ...
    def report_error_flags(self):
        ...
        # return response
        print("reporting error flags")  # TESTING
    ...
    def get_actual_temperature(self):
        ...
        # return temperature
        print("getting actual temerature")   # TESTING
    ...
    def get_target_temperature(self):
        ...
        # return temperature
        print("geting target temperature")
    ...
    def set_target_temperature(self, temperature: float = 22.0):
        ...
        print("setting target temperature")  # TESTINg
    ...
    def is_heater_active(self):
        ...
        #     raise (e)
        print("is heater active?")  # testing
    ...
    def report_door_status(self):
        ...
        # return response
        print("reporting door status")  # TESTING
    ...
    def report_labware(self):
        ...
        # return response
        print("reporting labware")   # TESTING
    ...
    def is_shaker_active(self):
        ...
        #     raise (e)
        print("is shaker active?")  # TESTING
    ...
    def set_shaker_parameters(self, amplitude: float = 2.0, frequency: float = 14.2):
        ...
        #     raise e
        print("setting shaker parameters")   # TESTING
    ...
    def format_response(self, response: str):
        ...
        print("formatting response") # TESTING
